...
weapon_hoffset = sprite_get_width(spr_weapon_slot)/1.5
weapon_voffset = sprite_get_height(spr_weapon_slot)+22
...
for (index=0; index<4; index++)
{
    ...
    draw_weapon_slot(objVarRead(wheel_player,"weapon"+string(index)),wheel_x+hoffset,wheel_y+voffset,1,wheel_alpha,weapon_flag)
}
