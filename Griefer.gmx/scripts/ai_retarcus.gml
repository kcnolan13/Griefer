...
if random(1) < percent_active
{
    ...
    if instance_exists(weapon_contemplating) and random (1 < 0.1)
        with (weapon_contemplating) weapon_press_space()
    ...
    if instance_exists(varRead("active_weapon"))
    {
        ...
        shooting_prob = varRead("rank")/array_length_1d(global.rank_names)+0.2
