/// @description draw_xpbar(x,y,fraction_full,fraction_really_full,scale,halign,valign,text_color,unused)
/// @function draw_xpbar
/// @param x
/// @param y
/// @param fraction_full
/// @param fraction_really_full
/// @param scale
/// @param halign
/// @param valign
/// @param text_color
...
draw_text(bar_left+5,top-5+scale,string_hash_to_newline(get_rank_name(xp_bar.rank)))
draw_set_valign(fa_top)
draw_set_font(fnt_hud)
draw_text(bar_left+5,top+XPBAR_HEIGHT+5*scale,string_hash_to_newline(string(floor(xp_bar.xp_earned))+" / "+string(floor(xp_bar.xp_this_rank))))
