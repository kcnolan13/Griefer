/// @description rag_create_doll(fracture_strength,force,force_direction)
/// @function rag_create_doll
/// @param fracture_strength
/// @param force
...
if string(varRead("pName")) = string(objVarRead(net_manager.my_doll,"pName"))
{
    ...
    net_manager.view_overscaler = __view_get( e__VW.HView, 0 )/768
