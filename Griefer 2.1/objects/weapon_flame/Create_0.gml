...
varWrite("sprite",spr_flame)
varWrite("name",global.flame)
varWrite("icon",spr_flame)
varWrite("bullet_icon",spr_none)
varWrite("pose",global.nade_pose)
varWrite("muzzle_offset",70)
varWrite("scale",global.flame_scale)
...
//shooting mechanics
varWrite("kick",0)
varWrite("bullet",bullet_flame)
varWrite("bullet_speed",68)
