/// @description draw_trajectory(x, y, speed, direction, gravity, rigidity, color, width, resolution, length, highlight, highlight_interval, alpha1, alpha2, alpha3, flag)
