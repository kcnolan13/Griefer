...
draw_text(hstart-0.5*hsep,vstart,string_hash_to_newline("#"))
draw_text(hstart+0*hsep,vstart,string_hash_to_newline("Player"))
draw_text(hstart+1*hsep,vstart,string_hash_to_newline("Kills"))
draw_text(hstart+2*hsep,vstart,string_hash_to_newline("Deaths"))
