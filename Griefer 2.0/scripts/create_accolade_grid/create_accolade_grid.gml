/// @description create_accolade_grid(left,top,right,bottom,halign,valign,grid_pad,col_total,create_all,force_num_per_row)
/// @function create_accolade_grid
/// @param left
/// @param top
/// @param right
/// @param bottom
