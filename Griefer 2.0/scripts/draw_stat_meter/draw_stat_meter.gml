/// @description draw_stat_meter(x,y,value,description,outer_color,inner_color,scale,backing_percent_full,actual_percent_full)
/// @function draw_stat_meter
/// @param x
/// @param y
/// @param value
/// @param description
...
/// @param inner_color
/// @param scale
/// @param backing_percent_full
/// @param actual_percent_full
var drawx = argument0
var drawy = argument1
...
draw_set_font(text_color)
draw_text_transformed(drawx,drawy+val_yoff,string_hash_to_newline(val),val_scale,val_scale,0)

//draw the description
draw_text_transformed(drawx,drawy+desc_yoff,string_hash_to_newline(desc),desc_scale,desc_scale,0)
