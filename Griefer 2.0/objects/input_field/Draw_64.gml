...
draw_text_ext_transformed(x+5*master_scale,y+image_yscale*sprite_get_height(sprite_index)/2*master_scale,string_hash_to_newline(string(input_string)+string(str_cursor)),text_linesep*master_scale/fnt_scale,(sprite_width-10)/fnt_scale,fnt_scale*master_scale,fnt_scale*master_scale,0)
draw_set_color(c_white)
