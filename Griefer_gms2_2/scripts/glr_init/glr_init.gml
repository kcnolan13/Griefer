/// @description glr_init(quality, width, height, view)
/// @function glr_init
/// @param quality
/// @param  width
/// @param  height
...
if(argument_count < 3){
    if(view_enabled){
        var s_width=__view_get( e__VW.WView, global.GLR_VIEW )+GLR_PADDING
        var s_height=__view_get( e__VW.HView, global.GLR_VIEW )+GLR_PADDING
    }
    else{
