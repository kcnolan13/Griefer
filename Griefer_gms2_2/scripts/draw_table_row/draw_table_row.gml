/// @description draw_table_row(x, y, color, text_color, life_flag, player_name, player_rank, points, kills, deaths, KDR, assists)
...
if prank != -99
{
    ...
    {
        draw_text(dx, txt_y, string_hash_to_newline(txt_fields[k]))
        dx += x_incr
    }
}
else
{
    draw_text(xdraw+10, txt_y, string_hash_to_newline(pname))
}
