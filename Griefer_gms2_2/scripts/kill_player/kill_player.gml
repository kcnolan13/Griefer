/// @description kill_player(player_obj,death_type,killer,hit_dir,hit_force,instrument_of_death,acc_autocomplete)
...
/// @param hit_dir
/// @param hit_force
/// @param instrument_of_death
/// @param acc_autocomplete
