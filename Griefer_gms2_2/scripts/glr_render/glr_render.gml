...
if(view_enabled){
    var v_x0 = __view_get( e__VW.XView, 0 ),
    v_y0 = __view_get( e__VW.YView, 0 ),
    v_x1 = v_x0+__view_get( e__VW.WView, 0 ),
    v_y1 = v_y0+__view_get( e__VW.HView, 0 );
}else{
    var v_x0 = 0,
    v_y0 = 0,
    v_x1 = room_width,
    ...
    if(size > 0 || size2 == 0){
        ...
        for(i = 0; i<size; i++){
            ...
            if (test_x * test_x + test_y * test_y < bcircle * bcircle ) {
                draw_sprite_ext(l[| 0], l[| 1], px-__view_get( e__VW.XView, 0 ), py-__view_get( e__VW.YView, 0 ), xscale, yscale, l[| 6], 0, 1);
            }
        }
        var inst;
        for(i = 0; i<size2; i++){
            ...
            with(inst)
                draw_sprite_ext(sprite_index, image_index, x-__view_get( e__VW.XView, 0 ), y-__view_get( e__VW.YView, 0 ), image_xscale, image_yscale, image_angle, 0, 1);
        }
        shader_reset();
        surface_reset_target();
    }
