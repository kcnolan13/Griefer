...
if slot_flag != FL_ACTIVE_WEAPON
    draw_text_transformed(slot_x,slot_y-slot_height/2-2*slot_scale,string_hash_to_newline(slot_name),slot_scale,slot_scale,0)

//draw ammo remaining
draw_set_halign(fa_center)
draw_set_valign(fa_bottom)
draw_text_transformed(slot_x-slot_width/2+24*slot_scale,slot_y+slot_height/2-2*slot_scale,string_hash_to_newline(""+string(slot_ammo)),slot_scale,slot_scale,0)
