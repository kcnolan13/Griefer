/// @description glr_resize_event(DO NOT USE THIS FUNCTION, IS FOR FUTURE GM UPDATES)
/// @function glr_resize_event
/// @param DO NOT USE THIS FUNCTION
/// @param  IS FOR FUTURE GM UPDATES
//currently useless
