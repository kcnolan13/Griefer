/// @description draw_armory_cache(list, x_center, length, padding, alpha)
/// @function draw_armory_cache
/// @param list
/// @param  x_center
/// @param  length
/// @param  padding
...
draw_set_alpha(1)
draw_text(room_width/2, cache_y-18, string_hash_to_newline("Cache"))
