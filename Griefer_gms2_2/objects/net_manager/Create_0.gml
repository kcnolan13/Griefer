...
azureURL = "http://10.0.0.8:8080"
homeURL = "http://www.kylenolan.net:8080"
serverURL = azureURL
...
if moveFile(grieferURL+"/Config/GameState.ini",launcherURL+"/Config/GameState.ini")
    printf("::: config transfer successful")
else
    printf(":::: CONFIG TRANSFER FAILED")
