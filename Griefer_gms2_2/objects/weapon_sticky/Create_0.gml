...
varWrite("sprite",spr_sticky)
varWrite("name",global.sticky)
varWrite("icon",spr_sticky)
varWrite("bullet_icon",spr_none)
varWrite("pose",global.nade_pose)
varWrite("muzzle_offset",70)
varWrite("scale",global.sticky_scale)
...
//shooting mechanics
varWrite("kick",0)
varWrite("bullet",bullet_sticky)
varWrite("bullet_speed",74)
